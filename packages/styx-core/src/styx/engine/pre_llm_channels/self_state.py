...
# Буквально из волны 15 (`peer_vad.py::OCTANTS`) — фразы рассчитаны на
# дативно-безличную конструкцию ("тебе/мне + наречие"), поэтому лучше
# ложатся на self-фрейминг, чем на исходный "прозвучал + наречие".
