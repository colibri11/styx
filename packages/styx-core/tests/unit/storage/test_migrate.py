...
EXPECTED_INDEXES = {
    ...
    "causal_operations_pending_idx",
    "memory_lineage_edge_key_uq", "memory_lineage_active_edge_uq",
    "memory_lineage_active_source_idx", "memory_lineage_active_target_idx",
